...
static_assert(sizeof(_EXCEPTION_RECORD)==0x50, "Win32 x86 EXCEPTION_RECORD ABI");
...
static_assert(sizeof(POINT_OLD)==8, "Win32 POINT ABI");
static_assert(sizeof(MSG_OLD)==28, "Win32 x86 MSG ABI");
static_assert(sizeof(RECT_OLD)==16, "Win32 RECT ABI");
static_assert(sizeof(ICONINFO_OLD)==20, "Win32 x86 ICONINFO ABI");
static_assert(sizeof(TBBUTTON_OLD)==20, "Win32 x86 TBBUTTON ABI used by original");
static_assert(sizeof(MENUITEMINFOA_OLD)==44, "pre-Win2000 MENUITEMINFOA ABI used by original");
...
static_assert(sizeof(OPENFILENAMEA_OLD)==0x4C, "Win32 4.00 OPENFILENAMEA x86 ABI");
